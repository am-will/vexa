...
<ResponseField name="OPENAI_API_KEY" type="string">
  OpenAI API key for text-to-speech. Required for the `/speak` command to work. Without this, bots can still join meetings and transcribe, but TTS will be unavailable.
</ResponseField>
