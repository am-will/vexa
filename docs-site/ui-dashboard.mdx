---
title: "Vexa Dashboard (UI)"
description: "Vexa Dashboard is the open-source web UI for Vexa: join meetings, view live transcripts, manage users/tokens, and review transcript history."
---
# Vexa Dashboard (UI)
