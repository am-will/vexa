...
description: "This repo supports a link-based flow for sending meeting transcripts to ChatGPT without embedding the full transcript in the ChatGPT URL (which can exceed brows"
---
