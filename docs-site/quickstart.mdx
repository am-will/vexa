...
- [`docs/meeting-ids.md`](meeting-ids)
...
<Steps>
  ...
  <Step title="Send a bot to a meeting">
    ...
    Full reference: [`docs/api/bots.md`](api/bots)
  </Step>
  ...
  <Step title="Fetch the transcript (and recording metadata, if present)">
    ...
    Full reference: [`docs/api/transcripts.md`](api/transcripts)
  </Step>
</Steps>

## Next Steps

- Live streaming: [`docs/websocket.md`](websocket)
- Post-meeting playback: [`docs/api/recordings.md`](api/recordings) + [`docs/recording-storage.md`](recording-storage)
- Delete/anonymize: [`docs/api/meetings.md`](api/meetings) (and read: [`docs/errors-and-retries.md`](errors-and-retries))
