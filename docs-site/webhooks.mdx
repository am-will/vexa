...
- `PUT /user/webhook` (see also: [`docs/api/settings.md`](api/settings))
...
- For local development, use a tunnel (ngrok/cloudflared): [`docs/local-webhook-development.md`](local-webhook-development)
