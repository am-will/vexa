...
| status-completed | Meeting.status=completed after stop (not failed/stuck) | 10 | ❌ fail | `helm`: containers/status_completed: status=failed (expected completed) after ~6x5s poll |
