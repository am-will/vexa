...
| packages-ci-workflow-exists | .github/workflows/test-packages.yml exists and runs npm test per package in matrix | 5 | ⬜ missing | `lite`: check PACKAGES_CI_WORKFLOW_EXISTS not found in any smoke-* report |
